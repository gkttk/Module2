...
public class OrderModelAssembler extends RepresentationModelAssemblerSupport<OrderDto, OrderDto>
    ...
    public CollectionModel<OrderDto> toCollectionModel(Iterable<? extends OrderDto> entities, Integer offset) {
        ...
        collectionModel.add(linkTo(methodOn(OrderController.class)
                .getAllForQuery(null, null, ApplicationConstants.DEFAULT_LIMIT, 0)).withRel(ApplicationConstants.FIRST_PAGE));
        collectionModel.add(linkTo(methodOn(OrderController.class)
                .getAllForQuery(null, null, ApplicationConstants.DEFAULT_LIMIT, offset + ApplicationConstants.DEFAULT_LIMIT))
